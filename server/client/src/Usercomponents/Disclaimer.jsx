...
function Disclaimer() {
    return (
        <div className=" container-fluid">
            ...
            <ol type="1">
                <li ><a className="text-dark" href="#consent"><strong>Consent</strong></a>
                </li>
                <li ><a className="text-dark" href="#content"><strong>Content Disclaimer</strong></a>
                </li>
                <li ><a className="text-dark" href="#personal"><strong>Personal Responsibility</strong></a>
                </li>
                <li ><a className="text-dark" href="#contact"><strong>Contact Us</strong></a>
                </li>
                <li ><a className="text-dark" href="#copyright"><strong>Copyright Information</strong></a>
                </li>
            ...
            <p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="personal">3 Personal Responsibility</h2><p>You acknowledge You are using Our Website voluntarily and that any choices, actions and results now and in the future are solely Your responsibility.</p>
            ...
            <p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="contact">4 Contact Us</h2><p>If You require any more information or have any questions about Our Website's disclaimer, please feel free to contact Us.</p>

            <p><a href="#tableofcontents">Back to table of contents</a></p><h2 id="copyright">5 Copyright Information</h2>COPYRIGHT 2021 smmdigg. ALL RIGHTS RESERVED.
            <p>This disclaimer was generated at: <a href="https://privacyterms.io/disclaimer-generator/">privacyterms.io</a>.</p>
        </div>
    )
}
